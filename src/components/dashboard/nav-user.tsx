...
import { LogoutButton } from "@/lib/auth/components/buttons/logout-btn";
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="size-8 rounded-lg">
                ...
                <AvatarFallback className="size-8 rounded-lg">{getInitials(user.name)}</AvatarFallback>
              </Avatar>
          ...
          >
            ...
            <DropdownMenuGroup>
              <DropdownMenuItem>
                <Link href="/dashboard/pricing" className="flex items-center gap-2 w-full">
                  <Sparkles />
                  Choisir un plan
                </Link>
              </DropdownMenuItem>
