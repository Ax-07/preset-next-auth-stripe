...
const features = [
  {
    ...
    description:
      "Description de votre première fonctionnalité principale. Expliquez comment elle résout un problème spécifique de vos utilisateurs.",
    icon: <Zap className="h-8 w-8" />,
    benefits: ["Avantage concret 1", "Avantage concret 2", "Avantage concret 3"],
  },
  {
    id: "feature-2",
    title: "Fonctionnalité 2",
    description:
      "Description de votre deuxième fonctionnalité. Mettez en avant la valeur unique qu'elle apporte à vos clients.",
    icon: <BarChart3 className="h-8 w-8" />,
    benefits: ["Bénéfice important 1", "Bénéfice important 2", "Bénéfice important 3"],
  },
  {
    id: "feature-3",
    title: "Fonctionnalité 3",
    description:
      "Votre troisième fonctionnalité clé. Décrivez comment elle améliore l'expérience utilisateur ou augmente la productivité.",
    icon: <Users className="h-8 w-8" />,
    benefits: ["Amélioration 1", "Amélioration 2", "Amélioration 3"],
  },
  {
    id: "feature-4",
    title: "Fonctionnalité 4",
    description:
      "Une fonctionnalité supplémentaire qui différencie votre produit de la concurrence. Expliquez son impact.",
    icon: <Shield className="h-8 w-8" />,
    benefits: ["Différenciation 1", "Différenciation 2", "Différenciation 3"],
  },
  {
    id: "feature-5",
    ...
    benefits: ["Valeur ajoutée 1", "Valeur ajoutée 2", "Valeur ajoutée 3"],
  },
  {
    id: "feature-6",
    title: "Fonctionnalité 6",
    description:
      "Une fonctionnalité bonus qui ravira vos utilisateurs. Décrivez comment elle simplifie leur quotidien.",
    icon: <Sparkles className="h-8 w-8" />,
    benefits: ["Simplification 1", "Simplification 2", "Simplification 3"],
  },
];
      ...
      <section className="py-20 text-center">
        <div className="container max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl mb-6">
            Tout ce dont vous avez besoin <span className="text-primary">en un seul endroit</span>
          </h1>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Découvrez comment notre plateforme révolutionne votre façon de travailler avec des fonctionnalités pensées
            pour votre succès.
          </p>
              ...
              >
                ...
                <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <Badge variant="secondary">Fonctionnalité {index + 1}</Badge>
                  </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {additionalFeatures.map((feature, index) => (
              <Card key={index} className="p-6 text-center">
                <div className="inline-flex p-3 bg-primary/10 rounded-lg text-primary mb-4">{feature.icon}</div>
