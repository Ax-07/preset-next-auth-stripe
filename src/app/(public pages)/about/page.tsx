...
import { Users, Target, Heart, Zap, Globe, Award, ArrowRight, Mail, Linkedin, Twitter } from "lucide-react";
...
const values = [
  {
    title: "Innovation",
    description:
      "Nous repoussons constamment les limites de ce qui est possible pour offrir des solutions avant-gardistes.",
    icon: <Zap className="h-8 w-8" />,
  },
  {
    title: "Transparence",
    description:
      "Une communication claire et honnête avec nos clients, partenaires et équipe est au cœur de tout ce que nous faisons.",
    icon: <Heart className="h-8 w-8" />,
  },
  {
    title: "Excellence",
    description:
      "Nous nous efforçons d'atteindre l'excellence dans chaque détail, de l'expérience utilisateur au support client.",
...
const team = [
  {
    ...
    role: "CEO & Fondateur",
    description:
      "10+ ans d'expérience dans le développement de produits SaaS. Passionné par l'innovation et l'excellence opérationnelle.",
  ...
  },
  {
    ...
    role: "CTO",
    description:
      "Experte en architecture logicielle et en sécurité. Elle supervise le développement technique de notre plateforme.",
  ...
  },
  {
    ...
    description:
      "Spécialiste en UX/UI et en développement produit. Il s'assure que notre solution répond parfaitement aux besoins utilisateurs.",
  ...
  },
  {
    ...
    description:
      "Dédiée à la réussite de nos clients. Elle accompagne chaque entreprise dans l'adoption et l'optimisation de notre solution.",
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {values.map((value, index) => (
              <Card key={index} className="p-6 text-center">
                <div className="inline-flex p-3 bg-primary/10 rounded-lg text-primary mb-4">{value.icon}</div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">{"Notre impact en quelques statistiques clés"}</p>
          </div>
