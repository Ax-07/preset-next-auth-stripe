  ...
  return (
    <>
      ...
      <section className="py-20 text-center">
        <div className="container max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Notre équipe support est là pour vous accompagner. Trouvez rapidement des réponses ou contactez-nous
            directement.
          </p>
          ...
          <div className="relative max-w-2xl mx-auto mb-8">
            ...
            <Input className="pl-10 h-12 text-lg" placeholder="Rechercher dans la documentation..." type="search" />
            <Button className="absolute right-1 top-1 bottom-1">Rechercher</Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {supportChannels.map((channel, index) => (
              <Card key={index} className="relative p-6 text-center hover:shadow-lg transition-shadow">
                ...
                <div className="inline-flex p-3 bg-primary/10 rounded-lg text-primary mb-4">{channel.icon}</div>
      ...
      <section className="py-20">
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">{`Ressources d'aide`}</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-20">
        <div className="container max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Envoyez-nous un message et nous vous répondrons rapidement.</p>
          </div>
          ...
          <Card className="p-8">
            <form className="space-y-6">
              ...
              <div>
                ...
                <Textarea placeholder="Décrivez votre problème ou votre question en détail..." rows={6} />
              </div>
