...
const blogPosts = [
  {
    ...
    excerpt:
      "Découvrez les meilleures pratiques pour améliorer l'expérience d'accueil de vos nouveaux clients et réduire le churn dès les premiers jours.",
  ...
  },
  {
    ...
    excerpt:
      "Quelles sont les KPIs indispensables pour piloter votre croissance SaaS ? Notre guide complet des métriques qui comptent vraiment.",
  ...
  },
  {
    ...
    excerpt:
      "Nous sommes ravis d'annoncer le lancement des rapports automatisés ! Gagnez du temps avec des insights générés automatiquement.",
  ...
  },
  {
    ...
    excerpt:
      "Tutorial step-by-step pour connecter votre compte à Slack et recevoir des notifications en temps réel de votre activité.",
  ...
  },
  {
    ...
    excerpt:
      "Nous avons obtenu les certifications SOC 2 et ISO 27001. Découvrez ce que cela signifie pour la sécurité de vos données.",
  ...
  },
  {
    ...
    excerpt:
      "Étude de cas : Découvrez comment TechCorp a transformé ses processus et multiplié sa croissance grâce à notre solution.",
  ...
  },
  {
    ...
    excerpt:
      "Optimisez votre tableau de bord avec ces conseils d'experts. Gagnez en visibilité et prenez de meilleures décisions.",
  ...
  },
  {
    ...
    excerpt:
      "Découvrez en exclusivité les fonctionnalités que nous préparons pour vous en 2024. Une année riche en innovations !",
  ...
  return (
    <>
        ...
        <section className="py-20">
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">{"Article à la une"}</h2>
            </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">{searchTerm ? `Résultats de recherche` : `Derniers articles`}</h2>
            {searchTerm && (
      ...
      <section className="py-20">
        <div className="container max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">{"Ne ratez aucun article"}</h2>
          ...
          <p className="text-xs text-muted-foreground mt-4">{"Pas de spam, désinscription possible à tout moment."}</p>
        </div>
      </section>
    </>
  );
