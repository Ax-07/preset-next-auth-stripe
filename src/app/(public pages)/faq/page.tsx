...
import { Search, MessageCircle, ArrowRight, CreditCard, Users, Shield, Zap, Settings, HelpCircle } from "lucide-react";
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Oui ! Nous nous integrons avec plus de X outils populaires : CRM (Salesforce, HubSpot), comptabilite (QuickBooks, Xero), communication (Slack, Teams), et bien d'autres. Notre API REST permet egalement des integrations sur mesure.",
      },
      {
      ...
      {!searchTerm && (
        <section className="py-12 bg-muted/30">
          <div className="container max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-12">Parcourir par catégorie</h2>
