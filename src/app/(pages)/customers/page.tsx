...
const testimonials = [
  {
    id: 1,
    quote: "Grâce à cette solution, nous avons pu réduire notre temps de traitement de 60% et améliorer significativement la satisfaction de nos clients. Un investissement qui s'est rentabilisé en moins de 3 mois.",
    author: {
      name: "Marie Dubois",
  ...
  {
    id: 2,
    quote: "L'interface intuitive et les fonctionnalités avancées nous ont permis de digitaliser complètement nos processus. Notre équipe a gagné en efficacité et nos clients sont ravis.",
    author: {
      name: "Pierre Martin",
      role: "CEO",
  ...
  {
    id: 3,
    quote: "Le support client est exceptionnel et la plateforme répond parfaitement à nos besoins. Nous recommandons vivement cette solution à toute entreprise cherchant à optimiser ses opérations.",
    author: {
      name: "Sarah Johnson",
      role: "Responsable IT",
...
const caseStudies = [
  ...
  },
  {
    ...
    testimonial: "Nos clients remarquent immédiatement la différence. Notre service client n'a jamais été aussi performant.",
    author: {
      name: "Sarah Johnson",
      role: "Responsable IT"
    },
                  ...
                  <div className={`grid gap-8 lg:grid-cols-2 ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}>
                    ...
                    <div className={`p-8 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="text-muted-foreground">{study.author.role}, {study.company}</div>
                      </div>
                    </div>

                    {/* Image placeholder */}
                    <div className={`aspect-video bg-muted flex items-center justify-center ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
          ...
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                {"Rejoignez plus de 500 entreprises qui utilisent notre solution"}
              </p>
            </div>
