...
export default function SecurityPage() {
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "pending":
        return <Badge className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400">En cours</Badge>;
      default:
        return null;
    }
  };
        ...
        <section className="py-20 text-center">
          <div className="container max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Nous mettons en œuvre les plus hauts standards de sécurité pour protéger 
              vos données et respecter votre confidentialité. Découvrez nos mesures de protection.
            </p>
