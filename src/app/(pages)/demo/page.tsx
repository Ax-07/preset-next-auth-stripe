...
const demoTestimonials = [
  {
    quote: "La démo m'a immédiatement convaincu. En 30 minutes, j'ai pu voir exactement comment la solution répondait à nos besoins.",
    author: "Thomas Leroux",
    role: "Directeur IT",
    company: "TechnoSoft"
  },
  {
    quote: "Présentation claire et professionnelle. L'expert a su répondre à toutes nos questions techniques complexes.",
    author: "Julie Moreau",
    role: "Chef de projet",
    company: "InnovateNow"
  }
          ...
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4">
                {"Choisissez votre type de démonstration"}
              </h2>
              ...
              <div className="space-y-6">
                <Card className="p-6">
                  <CardHeader className="px-0 pt-0">
                    ...
                    <CardDescription>
                      {"Sélectionnez le moment qui vous convient le mieux"}
                    </CardDescription>
                  </CardHeader>
        ...
        <section className="py-20">
          <div className="container max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                {"Pour approfondir votre découverte de notre solution"}
              </p>
            </div>
